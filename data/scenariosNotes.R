scenarioNotes <-
  data.frame(
    ...
    Notes =
      c(
        "For autumn-spawning stocks, the SSB is influenced by fisheries and natural mortality between 1 January and spawning.",
        ...
        "Estimated 2025 C-fleet TAC based on historical TAC setting: TAC C = (5.7%* TAC A)+(TAC SD22-24*41%*2). In 2025, TAC SD22-24 = 788 t, in line with the 2024 TAC. D -fleet TAC of 6 659 t, in line with the 2024 TAC."
      )
  )
